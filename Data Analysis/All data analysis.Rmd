...
```{r}
incomplete_data <- all_data[all_data$year < 4, ]
```
...
p2 <- ggplot(selected_data, aes(x = year, y = Total_CO2_capture, group = file_id)) +
  geom_smooth(se = FALSE, method = "loess", span = 1) +   # Add smoothed trend lines
